...
var chai = require('chai')
  , WorkweixinStrategy = require('../lib/strategy');


describe('Strategy', function() {
    
  describe('constructed', function() {
    var strategy = new WorkweixinStrategy({
        clientID: 'ABC123',
        clientSecret: 'secret'
      },
      function() {});
    ...
    it('should be named facebook', function() {
      expect(strategy.name).to.equal('workweixin');
    });
  })
  ...
  describe('constructed with undefined options', function() {
    it('should throw', function() {
      expect(function() {
        var strategy = new WorkweixinStrategy(undefined, function(){});
      }).to.throw(Error);
    });
  })
  ...
  describe('error caused by app being in sandbox mode', function() {
    ...
    it('should error', function() {
      expect(err.constructor.name).to.equal('WeiXinAuthorizationError');
  ...
  describe('error caused by invalid code sent to token endpoint (note: error format does not conform to OAuth 2.0 specification)', function() {
    ...
    it('should error', function() {
      expect(err.constructor.name).to.equal('WeiXinTokenError');
